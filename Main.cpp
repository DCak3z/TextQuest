// Main.cpp
// ClassyTextQuest (A2 Sample Solution)
...
void startGame() {
	...
	cout << "Hello adventurer! Welcome to ClassyTextQuest!" << endl;
...
void generateMap()
{
	//Generates rooms with random events and exits
	for (int i = 1; i < 20; i += 2)
	{
		for (int j = 1; j < 20; j += 2)
		{
			...
			int east = rand() % 3;
			int west = rand() % 3;
			room = new Room(north, south, east, west, j, i);
